  ...
  describe("tests where backend is working normally", () => {
    beforeEach(() => {
      ...
      axiosMock.onPut("/api/ucsborganization").reply(200, {
        orgCode: "SKY",
        orgTranslationShort: "Skydiving Club Updated",
        orgTranslation: "UCSB Skydiving Club Updated",
        inactive: false,
      });
    });
    ...
    test("Is populated with the data provided", async () => {
      ...
      expect(orgTranslationField).toHaveValue("UCSB Skydiving Club");
      expect(submitButton).toHaveTextContent("Update");

      fireEvent.change(orgTranslationShortField, {
        target: { value: "Skydiving Club Updated" },
      });
      fireEvent.change(orgTranslationField, {
        target: { value: "UCSB Skydiving Club Updated" },
      });
